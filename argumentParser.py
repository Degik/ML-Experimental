...
def argumentParser() -> dict[str, any]:
    ...
    parser.add_argument('-e','--epochs', type=int, default=150, help='Total training epochs', required=False)
    parser.add_argument('-b','--batch', type=int, default=100, help='Total batch size', required=False)
    ...
    parser.add_argument('-tb','--tensorB', type=bool, default=True, help='Activate tensorBoard for drawing the graph of Neural Network', required=False)
