...
def argumentParser() -> dict[str, any]:
    ...
    parser.add_argument('-e','--epochs', type=int, default=10000, help='Total training epochs', required=False)
    parser.add_argument('-b','--batch', type=int, default=1000, help='Total batch size', required=False)
